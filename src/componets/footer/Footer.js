...
function Footer() {
  return (
    <footer className="footer">
      {/* Sub-footer section with background color and padding */}
      <div className="sub-footer bg-[#262A2D] p-10 md:p-20">
        {/* Responsive grid layout for organizing footer links */}
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          <div>
            ...
            <div className="social-media-icons">
              <div className="social-media-icons flex space-x-4 pt-[90px]">
                <a
                  href="https://facebook.com"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Facebook"
                  className="text-[#C6CACD]"
                >
                  <FaXTwitter size={20} />
                </a>
                <a
          ...
          <div>
            <h2 className="text-xl pb-4 text-[#F4BF31]">Company</h2>
            <ul>
              <li className="pb-3">
                {/* Link to contributor page */}
                <a className="text-[#C6CACD]">Become a contributor</a>
              </li>
              <li className="pb-3">
                {/* Link to terms and conditions */}
                <a className="text-[#C6CACD]">Terms and Conditions</a>
              </li>
              <li className="pb-3">
                {/* Link to privacy policy */}
                <a className="text-[#C6CACD]">Privacy policy</a>
              </li>
            </ul>
          </div>

          {/* Column for "Pricing and Plans" links */}
          <div>
            <h2 className="text-xl pb-4 text-[#F4BF31]">Pricing and Plans</h2>
            <ul>
              <li className="pb-3">
                {/* Link to individual pricing plan */}
                <a className="text-[#C6CACD]">Individual Plan</a>
              </li>
              <li className="pb-3">
                {/* Link to company pricing plan */}
                <a className="text-[#C6CACD]">Company Plan</a>
              </li>
              <li className="pb-3">
                {/* Link to subscription options */}
                <a className="text-[#C6CACD]">Subscriptions</a>
              </li>
            </ul>
          </div>

          {/* Column for "Customer Support" links */}
          <div>
            <h2 className="text-xl pb-4 text-[#F4BF31]">Customer Support</h2>
            <ul>
              <li className="pb-3">
                {/* Link to contact page */}
                <a className="text-[#C6CACD]">Contact Us</a>
              </li>
              <li className="pb-3">
                {/* Link to help center */}
                <a className="text-[#C6CACD]">Help Center</a>
              </li>
            </ul>
          </div>
        </div>
      ...
      {/* Footer bottom section with text aligned to the right */}
      <div className="sub-footer p-3 text-right md:text-right bg-[#121619] text-[#FFFFFF]">
        {/* Copyright notice */}
